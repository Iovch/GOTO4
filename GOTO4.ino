/*
 * GOTO4_6.ino Written by Igor Ovchinnikov 18/07/2016
 */
...
#include "Config4_6.h" // Config4_6.h должен находиться в тойже папке, что GOTO4_6.ino
...
#include "GOTO4_6.h" // GOTO4_6.h должен находиться в тойже папке, что GOTO4_6.ino
